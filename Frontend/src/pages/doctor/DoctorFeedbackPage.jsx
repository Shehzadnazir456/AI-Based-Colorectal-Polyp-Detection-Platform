...
export function DoctorFeedbackPage() {
  ...
  return (
    <div>
      <PageHeader title="Feedback" subtitle="Help us improve PolyGuard AI with structured ratings and notes." />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <GlassCard>
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-6">
            ...
            <Textarea
              ...
              rows={5}
              placeholder="Usability, accuracy, latency, documentation…"
            />
        ...
        <GlassCard>
          <h3 className="text-lg font-semibold text-slate-900">My feedback</h3>
          {loading ? (
            ...
            <ul className="mt-6 space-y-4">
              {items.length === 0 ? (
                <li className="text-sm text-slate-500">No submissions yet.</li>
              ) : (
                items.map((f, i) => (
